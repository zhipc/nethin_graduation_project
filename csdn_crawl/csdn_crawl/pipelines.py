...
INSERT_SQL = "insert ignore into crawl(url, url_md5, title, author, content, content_md5, status) values('%(url)s', md5('%(url)s'), '%(title)s', '%(author)s', '%(content)s', md5('%(content)s'), 0)"
